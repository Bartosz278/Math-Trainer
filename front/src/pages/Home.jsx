...
function Home() {
  return (
    <div className="flex justify-center gap-2 sm:gap-5 mx-2 sm:mt-10 mt-3 flex-col sm:flex-row items-center overflow-auto">
      <Link to="/login">
        <div className="cursor-pointer sm:w-48 max-w-[400px] bg-gray-300 font-Inconsolata   rounded shadow-2xl border-2 border-gray-900/35 hover:shadow-[inset_-12px_-8px_40px_#46464620]">
